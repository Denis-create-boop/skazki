...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dishes', '0004_alter_categories_options'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='dishes.products', verbose_name='Продукт')),
            ],
            options={
